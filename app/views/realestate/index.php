                    ...
                    <div class="btn-group">
                        ...
                        <div class="btn-group">
                            <a class="btn user-btn dropdown-toggle" data-toggle="dropdown" href="#"><span
                                    class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;<span class="user-name"><?=$_SESSION['user']->name?></span></a>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-md-offset-1">
                                    <h1 class="wlcm-h1">Welcome <span class="user-color"> <?=$_SESSION['user']->name?>!</span></h1>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-9 col-md-offset-1">
