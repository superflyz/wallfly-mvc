...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-8">
        <h1 class="wlcm-h1">Welcome <span class="user-color"><?php echo $_SESSION['user']->name?>!</span></h1>
    </div>   
            <div class="col-md-4">
    ...
    <div class="col-md-12">
        <div class="row dash_p_list">
            ...
            foreach ($properties as $property) {
                ?>
                <div class="col-md-3">
                    <form id="viewDetails" method="post" action="<?=WEBDIR?>/realest/viewDetails">
                        <div class="dash_p">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- FORM STARTS HERE -->
                <form action="<?=WEBDIR?>/realest/addproperty" method="post">
