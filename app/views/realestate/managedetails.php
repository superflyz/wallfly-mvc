                    ...
                    <div class="col-md-8">
                        ...
                        <div class="pd_btns">
                            <div class="pull-right">
                                ...
                                <button class="btn btn-add-tenant" id="triggermodal" data-toggle="modal" data-target="#tenantForm">Change assigned agent</button>
                                <?php endif ?>
                            </div>
                        </div>
                    </div>
...
<div class="modal modal-vcenter fade" id="tenantForm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <p class="modal-title">Assign new agent</p>
            </div>
            <div class="modal-body">
                <form action="<?=WEBDIR?>/realest/changeagent" id="assignNewForm" method="post">
                    <div class="form-field">
                        <label for="agent">Select agent:</label>
                        <select name="agent" id="agent" class="form-control">
                            <option disabled selected hidden>Please select...</option>
                            <?php foreach ($_SESSION['user']->getAgents() as $agent): ?>
                    ...
                    <div class="col-md-12">
                        <div class="at_btnz">
                            <button type="submit" id="submit" class="btn btn-save-changes pull-right">Save changes</button>
                        </div>
                    </div>
                </form>
                <!-- FORM ENDS HERE -->
