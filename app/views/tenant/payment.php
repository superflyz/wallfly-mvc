...
<div class="row t_payments">
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">      
        <img class="paypal pull-right" src="<?=WEBDIR?>/images/paypal.png" />
    </div>
</div>
        ...
        <div class="manage_properties_pills">
          ...
          <ul class="nav nav-pills nav-justified properties_pills">
             ...
             <li role="presentation"><a href="#payment_history" aria-controls="payment_history" role="pill" data-toggle="pill" >Payment History</a></li>
              <li role="presentation"><a href="#add_payment" aria-controls="add_payment" role="pill" data-toggle="pill">Pay Rent</a></li>
          </ul>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                       ...
                       <div class="row add_payment_btn">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                <button type="submit" name="Submit" value="submit" id="submit-btn" class="btn btn-pay_now pull-right">Pay now</button>
                        </div>
                        </div>
                    </form>
                    <?php }?>
