            ...
            <div class="navbar-dashboard-main">
                ...
                <div class="user pull-right">
                    <div class="btn-group">
                        ...
                        <div class="btn-group">
                            <a class="btn user-btn dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;<span class="user-name"><?=$_SESSION['user']->firstname . ' ' . $_SESSION['user']->lastname?></span></a>
